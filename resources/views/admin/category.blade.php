...
<head>
    ...
    <title> Catégorie articles blog | {{ config('app.name') }} </title>
    <x-css-file />
</head>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Catégorie articles blog</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12 mb-3">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="card-title">Catégorie articles blog</div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouvelle Catégorie article blog </h6>
                    ...
                    <form action="#" id="f-add">
                        <div class="modal-body text-start">
                            <div class="col-xl-12 mb-3">
                                <label for="signin-username" class="form-label text-default">Catégorie articles blog</label>
                                <input required type="text" name="categorie" class="form-control form-control-sm"
                                    id="signin-username">
                            </div>
                            <small class="text-danger"><i class="bx bx-info-circle"></i> Vous pouvez ajouter plusieurs
                                Catégorie à la fois, Ex : Categorie1; Categorie2; Categorie3</small>
                            <div class="mt-2">
                                <div id="rep"></div>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        res.data.forEach((el, i) => {
                            ...
                            <td>${el.categorie}</td>
                            <td>
                                Article blog : ${el.publications_count}
                            </td>
                            <td>
                        ...
                        $('[bedit]').off('click').click(function() {
                            ...
                            $('[name=categorie]', mdl).val(data.categorie);
                            mdl.modal('show');
                        });
                        table.DataTable({
                            order: [],
