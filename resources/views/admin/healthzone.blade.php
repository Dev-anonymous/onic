...
<head>
    ...
    <title> Zone de santé | {{ config('app.name') }} </title>
    <x-css-file />
</head>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Zone de santé</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouvelle zone de santé </h6>
                    ...
                    <form action="#" id="f-add">
                        <div class="modal-body text-start">
                            ...
                            <small class="text-danger"><i class="bx bx-info-circle"></i> Vous pouvez ajouter plusieurs
                                zones à la fois, Ex : zone1; Zone2; zone3</small>
                            <div class="mt-2">
                                <div id="rep"></div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        res.data.forEach((el, i) => {
                            ...
                            <td>${el.zonesante}</td>
                            <td>
                                Aires de sante : ${el.airesante} <br/>
                                Structure de sante : ${el.structuresante}
                            </td>
                            <td>
                        ...
                        $('[bedit]').off('click').click(function() {
                            ...
                            $('[name=zonesante]', mdl).val(data.zonesante);
                            mdl.modal('show');
                        });
                        table.DataTable({
                            order: [],
            ...
            $('#fdel').submit(function() {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{ route('zonesante.destroy', '') }}/' + id,
                    success: function(r) {
                        if (r.success) {
                            btn.attr('disabled', false);
                            rep.removeClass().addClass('text-success');
