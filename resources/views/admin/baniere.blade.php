...
<head>
    ...
    <title> Bannière | {{ config('app.name') }} </title>
    <x-css-file />
</head>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bannière</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouvelle bannière </h6><button aria-label="Close" class="btn-close"
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        res.data.forEach((user, i) => {
                            html += `<tr>
                            <td>${i+1}</td>
                            <td><img src="{{ asset('storage') }}/${user.image}" alt="img" width="32" height="32" class="rounded-circle"></td>
                            <td>${user.titre}</td>
